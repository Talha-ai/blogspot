          ...
          <div>
            ...
            <form className="flex flex-col gap-2">
              <input
                ...
                className="px-4 py-2 rounded-md focus:outline-none text-white flex-grow"
              />
              <button
                type="submit"
                className="bg-[#2196f3] hover:bg-blue-600 text-white px-4 py-2 rounded-md transition-colors"
              >
                Subscribe
              </button>
            </form>
