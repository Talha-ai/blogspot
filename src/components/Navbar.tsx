  ...
  return (
    <header className="fixed top-0 left-0 w-full h-[75px] flex justify-between items-center bg-[#2196f3] text-white z-50">
      ...
      <nav className="hidden lg:flex items-center">
        ...
        <button
          className="text-lg font-semibold px-4 py-1 border-2 border-white rounded-md bg-transparent text-white hover:bg-white hover:text-[#2196f3] transition-colors duration-300 ml-[370px]"
